...
class VisionTransformer(nn.Module):
    ...
    """
    def __init__(self, num_classes=2, embed_dim=64, returnFeatures=False, depth=3,
                 num_heads=8, mlp_ratio=2., qkv_bias=False, mlp_head=False, drop_rate=0.2, attn_drop_rate=0.):
        super().__init__()
        ...
        if mlp_head:
            ...
            self.head = Linear(embed_dim, 1)      # 1个node
